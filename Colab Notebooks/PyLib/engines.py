...
dispatch_engine = {
    EMGOME_NO_MNIST_GAN  : Engine_mnist_GAN,
...
class Engine_pix2pixGAN(Engine_Base):
    def __init__(self):
        self.name_generator     = '/model_pix2pixgan_gene.h5'
        self.name_discriminator = '/model_pix2pixgan_disc.h5'
...
class Engine_mnist_GAN(Engine_Base):
    def __init__(self):
        self.name_generator     = '/model_mnist_gan_gene.h5'
        self.name_discriminator = '/model_mnist_gan_disc.h5'
